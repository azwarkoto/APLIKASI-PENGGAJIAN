...
<div class="wrapper">
  ...
  <header class="main-header">
    ...
    <a href="index2.html" class="logo">
      ...
      <span class="logo-lg"><b>App</b>Penggajian</span>
    </a>
      ...
      <div class="navbar-custom-menu">
        <ul class="nav navbar-nav">
              ...
              <li>
                ...
                <ul class="menu">
                  <li><!-- start message -->
                    <a href="#">
                      <div class="pull-left">
                        <img src="<?php echo base_url() ?>assets/admin/dist/img/fazri.jpg" class="img-circle" alt="User Image">
                      </div>
                      <h4>
                        Support Team
          ...
          <li class="dropdown user user-menu">
            <a href="#" class="dropdown-toggle" data-toggle="dropdown">
              <img src="<?php echo base_url() ?>assets/admin/dist/img/fazri.jpg" class="user-image" alt="User Image">
              <span class="hidden-xs">Abdul dan sayudin</span>
            </a>
            <ul class="dropdown-menu">
              <!-- User image -->
      ...
      <ul class="sidebar-menu" data-widget="tree">
        ...
        <li class="active treeview">
          ...
          <a href="<?php echo base_url() ?>Absensi">
            <i class="fa fa-edit"></i> <span>Absen</span>
            <span class="pull-right-container">
        ...
        <li>
          <a href="<?php echo base_url() ?>jabatan">
            <i class="fa fa-user"></i> <span>Jabatan</span>
            <span class="pull-right-container">
              <small class="label pull-right bg-green">new</small>
            </span>
          </a>
          <a href="<?php echo base_url() ?>gaji_karyawan">
            <i class="fa fa-files-o"></i> <span>Gaji Karyawan</span>
            <span class="pull-right-container">
            </span>
          </a>
          <a href="<?php echo base_url() ?>Tunjangan">
            <i class="fa fa-folder"></i> <span>Tunjangan</span>
            <span class="pull-right-container">
            </span>
          </a>
  ...
  <footer class="main-footer">
    ...
    <strong>Copyright &copy; 2019 <a href="#">Sayudin dan abdul robi padri</a>.</strong> All rights
    Tim
  </footer>
